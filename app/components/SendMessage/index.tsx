...
export function SendMessage({ username }: SendMessageProps) {
  ...
  const isDisabled = isPending || !username;

  return (
    <section className="w-full p-4 border-t border-gray-300 bg-primary-light">
      <form action={formAction} className="flex gap-4">
        <input
          type="text"
          name="message"
          placeholder={username ? "Type here..." : "Set your username first..."}
